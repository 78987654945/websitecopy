...
function stand() {
    ...
    if (dealervalue > 21) {
        dealerloss += 1
        document.getElementById('div_player').style.background = "green";
        document.getElementById('div_dealer').style.background = "red";
        setTimeout(function(){
        window.location.reload();
    }, 2000);
    }
    if (dealervalue > playervalue && dealerloss == 0) {
        document.getElementById('div_dealer').style.background = "green";
        document.getElementById('div_player').style.background = "red";
        setTimeout(function(){
        window.location.reload();
    }, 2000);
    }
